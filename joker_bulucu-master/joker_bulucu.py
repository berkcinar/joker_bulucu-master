...
yemek.sepeti.joker.2018@outlook.com
Joker2018Joker
yemek.sepeti.2018
...
Akatlar Mahallesi Ebulula Mardin Caddesi Yıldırım Oğuz Göker Sokak Maya Carton 17 D:4 Beşiktaş/Akatlar - Akatlar
...
class JokerFinder:
    def __init__(self):
        self.driver = webdriver.Chrome('C:/Users/Berk/PycharmProjects/yemeksepeti/chromedriver.exe')
    ...
    def entry_page(self):
        ...
        self.entry_logo=self.driver.find_element_by_xpath("/html/body/header/div[2]/div/div/div[1]/a[1]").click()
    ...
    def _run(self):
        ...
        while again:
            ...
            '''
kapat                   //*[@id="cboxClose"]
içine tıkla                //*[@id="cboxLoadedContent"]/div/div/div[2]
if exist                    //*[@id="colorbox"]
kalan süre                  //*[@id="cboxLoadedContent"]/div/div/div[3]/p[2]/span[2]

2 joker                     //*[@id="cboxLoadedContent"]/div/div/div[2]/div[2]

ilk jokerin resmi           //*[@id="cboxLoadedContent"]/div/div/div[2]/div[2]/a[1]/div[2]/img
